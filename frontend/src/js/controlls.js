  ...
  class BasicCharacterController {
    ...
    _LoadModels() {
      ...
      loader.load(path, (fbx) => {
        ...
        const idle = require('../assets/character_Animations/idle.fbx'); // eslint-disable-line
        const walk = require('../assets/character_Animations/walk.fbx'); // eslint-disable-line
        const jump = require('../assets/character_Animations/jump.fbx'); // eslint-disable-line
        const attack = require('../assets/character_Animations/attack.fbx'); // eslint-disable-line

        loader.load(idle, (a) => { _onLoad('idle', a); });
        loader.load(walk, (a) => { _onLoad('walk', a); });
        loader.load(jump, (a) => { _onLoad('jump', a); });
        loader.load(attack, (a) => { _onLoad('attack', a); });
      });
    }
    ...
    _onKeyDown(event) {
      switch (event.keyCode) {
        ...
        case 38:
          ...
          break;
        case 88: // x and j (attack)
        case 74:
          this._keys.attack = true;
          break;
        default:
          return null;
      }
  ...
  class LoadModelDemo {
    ...
    _Initialize() {
      ...
      const plane = new THREE.Mesh(
        new THREE.PlaneGeometry(500, 100, 64, 64),
        new THREE.MeshStandardMaterial({
          map: floorTexture,
        }),
      );
